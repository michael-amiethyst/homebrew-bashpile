...
@parser::header {
import com.bashpile.engine.Types;
}
...
expr locals [ Types type = Types.UNDEF ]
    : ID OPAREN arglist? CPAREN     # functionCallExpr
    | expr (MUL|DIV|ADD|MINUS) expr # calcExpr
    | MINUS? NUMBER {$type = Types.valueOf($NUMBER);}                # numberExpr
    | ID                            # idExpr
    | STRING {$type = Types.STR;}                                       # stringExpr
