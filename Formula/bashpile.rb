class Bashpile < Formula
  ...
  license "MIT"
  # TODO bump version before PR
  url "https://github.com/michael-amiethyst/homebrew-bashpile", using: :git, branch: "main", tag: "0.21.0"
  head "https://github.com/michael-amiethyst/homebrew-bashpile", using: :git, branch: "feature/conditionals2"
