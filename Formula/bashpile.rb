class Bashpile < Formula
  ...
  license "MIT"
  # TODO bump version after install test, before PR
  url "https://github.com/michael-amiethyst/homebrew-bashpile", using: :git, branch: "main", tag: "0.17.0"
  head "https://github.com/michael-amiethyst/homebrew-bashpile", using: :git, branch: "feature/brew-test"
